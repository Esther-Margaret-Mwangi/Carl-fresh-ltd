...
const pillars = [
  ...
  {
    icon: '🌱', title: 'Good Agricultural Practices (GAP)',
  ...
  {
    icon: '🔗', title: 'Traceability Systems',
  ...
  {
    icon: '❄️', title: 'Cold Chain Management',
...
const certs = [
  { icon: '🏅', title: 'HACCP', desc: 'Hazard Analysis Critical Control Points certification for food safety management.' },
  { icon: '🌱', title: 'GlobalG.A.P.', desc: 'Good Agricultural Practices certification recognised by retailers worldwide.' },
  { icon: '🔍', title: 'Kenya KEBS', desc: 'Kenya Bureau of Standards compliance for domestic and export quality standards.' },
  { icon: '🌿', title: 'KEPHIS', desc: 'Kenya Plant Health Inspectorate Service phytosanitary certification for all exports.' },
];
          ...
          <div className="quality-intro-grid">
            ...
            <div style={{ borderRadius: '20px', overflow: 'hidden', aspectRatio: '4/3' }}>
              <img
                ...
                alt="Quality inspection at Carl Fresh Produce facility"
      ...
      <section className="certs-display page-section" style={{ background: '#fff' }}>
        <div className="container-xl">
          ...
          <div className="certs-display-grid">
            {certs.map((c) => (
              <div key={c.title} className="cert-display-card">
