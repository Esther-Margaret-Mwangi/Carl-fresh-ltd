...
const haccpSteps = [
  {
    ...
    desc: "Identifying potential biological, chemical and physical hazards at each production step.",
  },
  {
    num: "02",
    title: "Critical Control Points",
    desc: "Determining the points in the process where hazards can be prevented, eliminated or reduced.",
  },
  {
    num: "03",
    title: "Critical Limits",
    desc: "Establishing measurable limits (temperature, pH, time) for each critical control point.",
  },
  {
    num: "04",
    title: "Monitoring Procedures",
    desc: "Regular monitoring of each CCP to ensure critical limits are consistently met.",
  },
  {
    num: "05",
    title: "Corrective Actions",
    desc: "Defined procedures for corrective action when monitoring indicates a CCP is not under control.",
  },
  {
    num: "06",
    title: "Verification & Records",
    desc: "Regular verification activities and comprehensive record-keeping to confirm the HACCP system is effective.",
  },
];
    ...
    <main>
      <div className="page-hero">
        <div className="container-xl" style={{ position: "relative" }}>
          <div className="section-label">Quality & Food Safety</div>
          ...
          <div className="quality-intro-grid">
            <div>
              ...
              <div className="quality-intro-text">
                <p>
                  At Carl Fresh Produce Limited, quality is not an afterthought
                  — it is the foundation of our business. From the moment seeds
                  are planted to the instant a consignment is loaded for export,
                  every step is governed by internationally recognised quality
                  and food safety standards.
                </p>
                <p>
                  We work closely with our partner farmers, providing training,
                  agronomic support and the tools they need to meet the exacting
                  requirements of European supermarkets, Middle Eastern
                  importers and Asian food processors.
                </p>
                <p>
                  Our in-house quality team conducts pre-harvest inspections,
                  supervises packing operations, and performs final inspection
                  before every consignment is certified for export.
                </p>
              </div>
            </div>
            <div
        ...
        <div className="container-xl">
          <div style={{ textAlign: "center" }}>
            ...
            <p className="section-subtitle" style={{ margin: "0 auto" }}>
              Five interconnected pillars form the basis of our comprehensive
      ...
      >
        <div className="container-xl">
          <div style={{ textAlign: "center" }}>
            ...
            {divider()}
            <p className="section-subtitle" style={{ margin: "0 auto" }}>
              Internationally recognised certifications demonstrate our
              commitment to food safety, quality and responsible production.
            </p>
          </div>
      ...
      <section className="cta-banner">
        <div className="container-xl">
          ...
          <p>
            Our quality team is ready to provide detailed documentation and
          ...
          <div className="cta-banner-actions">
            ...
            <Link to="/sustainability" className="btn-outline-white">
              View Sustainability
            </Link>
          </div>
        </div>
