...
const allProducts: Product[] = [
  // Fruits
  {
    emoji: '🥑', name: 'Avocados', category: 'Fruits',
  ...
  {
    emoji: '🥭', name: 'Mangoes', category: 'Fruits',
  ...
  {
    emoji: '🍍', name: 'Pineapples', category: 'Fruits',
  ...
  {
    emoji: '🌿', name: 'Purple Passion Fruits', category: 'Fruits',
  ...
  // Vegetables
  {
    emoji: '🫘', name: 'Fine Beans', category: 'Vegetables',
  ...
  {
    emoji: '🫛', name: 'Snap Peas', category: 'Vegetables',
  ...
  {
    emoji: '❄️', name: 'Snow Peas', category: 'Vegetables',
  ...
  // Herbs & Spices
  {
    emoji: '🌶️', name: 'Long Cayenne Chili', category: 'Herbs & Spices',
  ...
  {
    emoji: '🌶️', name: 'Thin Chili', category: 'Herbs & Spices',
  ...
  {
    emoji: '🫑', name: 'Bullet Chili', category: 'Herbs & Spices',
    ...
    <main>
                ...
                <img
                  ...
                  onError={(e) => {
                    ...
                    if (e.currentTarget.parentElement) {
                      e.currentTarget.parentElement.textContent = product.emoji;
                    }
                  }}
                />
              </div>
              <div className="product-detail-body">
                ...
                <div className="product-specs">
                  ...
                  <div className="product-spec">
                    <span className="spec-icon">📋</span>
                    <div className="spec-content">
                      <span className="spec-label">Quality Specs</span>
                      <span className="spec-value">{product.specs}</span>
                    </div>
                  </div>
                  <div className="product-spec">
                    <span className="spec-icon">🌍</span>
                    <div className="spec-content">
                      <span className="spec-label">Export Markets</span>
                      <span className="spec-value">{product.markets}</span>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="product-packaging-chips">
                    {product.packaging.map(p => (
                      <span key={p} className="packaging-chip">{p}</span>
                    ))}
                  </div>
                </div>
      ...
      <section className="cta-banner">
        <div className="container-xl">
          ...
          <p>
            Contact our export team for tailored packaging, volume pricing
            and supply schedule discussions.
          </p>
